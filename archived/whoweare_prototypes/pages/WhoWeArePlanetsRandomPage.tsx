...
const ThreeScenePlanetsRandom = lazy(() => import('../components/whoweare/ThreeScenePlanetsRandom'));

// Import team members data from the original page
import { whoweareTeamMembers, WhoWeAreMemberData } from './WhoWeArePage';

const WhoWeArePlanetsRandomPage: React.FC = () => {
...
export default WhoWeArePlanetsRandomPage;