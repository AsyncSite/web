...
function ProfilePage(): React.ReactNode {
  ...
  return (
    <div className={styles.profilePage}>
      ...
      {/* 이력서 첨삭 섹션 */}
      <section className={styles.resumeLinkSection}>
        <Link to="/resume" className={styles.resumeLinkCard}>
          <div className={styles.resumeLinkContent}>
            <span className={styles.resumeLinkIcon}>
            ...
            <div>
              <h4 className={styles.resumeLinkTitle}>이력서 첨삭 결과</h4>
              <p className={styles.resumeLinkDescription}>AI 이력서 첨삭 결과를 확인하고 다운로드하세요</p>
            </div>
          </div>
          <span className={styles.resumeLinkArrow}>→</span>
        </Link>
      </section>
