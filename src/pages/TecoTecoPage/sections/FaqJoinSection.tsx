    ...
    <section className="tecoteco-faq-join-section">
      ...
      <div className="tecoteco-faq-items">
        {tecotecoFaqs.map((faq) => (
          <div key={faq.id} className={`tecoteco-faq-item ${openFaqId === faq.id ? 'open' : ''}`}>
            <div
            ...
            >
              ...
              <span className="tecoteco-faq-toggle-icon">{openFaqId === faq.id ? '▲' : '▼'}</span>
            </div>
            {openFaqId === faq.id && (
      ...
      <div className="join-cta-block">
        ...
        <p className="join-description"></p>
