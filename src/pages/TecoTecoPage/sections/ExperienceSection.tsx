  ...
  const StepIllustrations = {
    ...
    1: (
      <svg width="200" height="200" viewBox="0 0 200 200" className="step-illustration">
        ...
        {/* 질문표들 */}
        <text x="70" y="68" textAnchor="middle" fill="#666" fontSize="14" fontWeight="bold">
          ?
        </text>
        <text x="130" y="88" textAnchor="middle" fill="#666" fontSize="16" fontWeight="bold">
          ?
        </text>

        {/* 에너지 라인 */}
        <path
          d="M 85 100 Q 70 85 70 60"
          stroke="#C3E88D"
          strokeWidth="2"
          fill="none"
          strokeDasharray="4,4"
    ...
    2: (
      <svg width="200" height="200" viewBox="0 0 200 200" className="step-illustration">
        ...
        {/* 나선형 탐구 경로 */}
        <path
          d="M 100 100 Q 120 90 130 100 Q 125 120 100 125 Q 75 120 70 100 Q 75 80 100 85"
          stroke="#C3E88D"
          strokeWidth="2"
          fill="none"
          strokeDasharray="3,3"
