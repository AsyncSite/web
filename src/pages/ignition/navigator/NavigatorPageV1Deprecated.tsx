 ...
 * This is the V1 version that doesn't properly handle is_parsed flag.
 * Use NavigatorPageV2 instead which correctly filters unparsed jobs.
 * 
 * Deprecated on: 2025-08-21
 * Reason: Shows empty jobs that haven't been parsed by LLM yet
 * Migration: Use NavigatorPageV2 from /ignition/navigator
 */
...
import './NavigatorPageV1Deprecated.css';
          ...
          <div className="ignition-nav-list-layout">
            <NavigatorFilters 
              ...
              onFilterChange={(newFilters) => {
                // Only update the filters that NavigatorPage V1 uses
                if (newFilters.companies !== undefined || 
                    newFilters.skills !== undefined || 
                    newFilters.experience !== undefined) {
                  setFilters({
                    companies: newFilters.companies || filters.companies,
                    skills: newFilters.skills || filters.skills,
                    experience: newFilters.experience || filters.experience
                  });
                }
              }}
              companies={companies}
