    ...
    <section id="worldview">
      ...
      <div className="highlight-box">
        ...
        <div className="highlight-desc">
          ...
          <br />
          - 꾸준함 (Consistency)
          <br />- 점들의 연결 (Networking)
        </div>
      </div>
      <div className="code-block">
        <p>
          <span className="keyword">function</span> <span className="function-name">worldview</span>
          () {'{'}
        </p>
        ...
        <p>
          {'  '}
          console.log(
          <span className="string">"느슨하지만 끈끈하게, 무임승차 없이 모두가 주인공!"</span>
          );
        </p>
        <p>{'}'}</p>
        <p>
          <span className="comment">// 함께 공유하며, 각자의 속도로 달리는 것이 세계관의 본질</span>
